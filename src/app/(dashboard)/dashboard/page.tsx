...
const T = {
  ru: {
    ...
    emptyTitle: 'Создайте первый турнир',
    emptyDesc: 'Займёт меньше минуты. Добавьте команды — расписание сгенерируется автоматически.',
    start: 'Начать',
    active: 'Активен',
    setup: 'Настройка',
    features: [
  ...
  kz: {
    ...
    emptyTitle: 'Бірінші турнирді жасаңыз',
    emptyDesc: 'Бір минуттан аз уақыт кетеді. Командаларды қосыңыз — кесте автоматты түрде жасалады.',
    start: 'Бастау',
    active: 'Белсенді',
    setup: 'Баптау',
    features: [
  ...
  en: {
    ...
    emptyDesc: 'Takes less than a minute. Add teams — the schedule generates automatically.',
    start: 'Start',
    active: 'Active',
    setup: 'Setup',
    features: [

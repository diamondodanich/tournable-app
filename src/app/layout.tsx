...
const DESCRIPTION =
  'Создавайте турниры по футболу, баскетболу, волейболу и другим видам спорта за минуту: автоматическое расписание, турнирная таблица, плей-офф сетка, статистика игроков и Live-табло. Делитесь результатами по ссылке — без регистрации для зрителей.'

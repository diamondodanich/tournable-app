        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 sm:p-10">
          ...
          <Section title="5. Передача данных третьим лицам">
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              ...
              <li><strong>Платёжный оператор</strong> — сертифицированный сервис интернет-эквайринга (Казахстан). Передаются: email при совершении платежа для получения чека. Данные банковской карты обрабатываются исключительно платёжным оператором и не поступают Оператору сервиса.</li>

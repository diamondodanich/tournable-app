      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 sm:p-10">
          ...
          <Section title="1. Общие положения">
            ...
            <p>Оператором персональных данных является ИП Tournable.app, адрес: г. Астана, Проспект Мангилик Ел, 55/1 (далее — «Оператор»). Политика разработана в соответствии с требованиями Закона Республики Казахстан «О персональных данных и их защите» от 21 мая 2013 года № 94-V ЗРК и иных применимых нормативных актов.</p>
          ...
          <Section title="7. Права пользователя">
            ...
            <p>Для реализации прав направьте запрос на email: <a href="mailto:info@tournable.app" className="text-emerald-600 hover:underline">info@tournable.app</a>. Мы ответим в течение 10 рабочих дней.</p>
          </Section>
          ...
          <Section title="11. Контактная информация">
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>Оператор: ИП Tournable.app</li>
              <li>Адрес: Республика Казахстан, г. Астана, Проспект Мангилик Ел, 55/1</li>

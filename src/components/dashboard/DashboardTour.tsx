...
const T = {
  ru: {
    ...
    live: { title: 'Табло', desc: 'Ведите матч в реальном времени с телефона: счёт, голы, карточки. На всех планах.' },
  ...
  kz: {
    ...
    live: { title: 'Тақта', desc: 'Матчты телефоннан нақты уақытта жүргізіңіз. Барлық жоспарларда.' },
  ...
  en: {
    ...
    live: { title: 'Scoreboard', desc: 'Run a match in real time from your phone. Available on all plans.' },

...
const T = {
  ru: {
    ...
    live: {
      badge: 'Live-табло',
      h2: ['Участники видят счёт.', 'Без приложений.'],
      sub: 'Отправьте ссылку в чат до матча. Вносите голы с телефона — все видят счёт, карточки и таймер мгновенно. Без скачиваний. Без регистрации.',
      items: [
        'Таймер с накопленным временем, паузой и дополнительным временем',
        'Голы и ассисты с привязкой к игроку и минуте',
        'Жёлтые и красные карточки в хронологии матча',
        'Публичный URL — один клик, и вся команда в курсе',
      ],
    },
    stats: {
      h2: ['Статистика — сама.', 'Экспорт — одним кликом.'],
      sub: 'Никакого ручного подсчёта. Бомбардиры, ассистенты, дисциплина — всё пересчитывается автоматически после каждого результата.',
      items: [
        'Таблица бомбардиров и ассистентов с актуальными данными',
        'Учёт жёлтых, красных и предупреждений по каждой команде',
        'Автоматический расчёт разницы мячей и очков',
        'Экспорт полного отчёта в PDF — для печати или соцсетей',
      ],
    },
    features: {
      tag: 'Возможности',
      ...
      items: [
        ...
        { title: 'Несколько редакторов', desc: 'Возьми помощника — до 3 соредакторов вводят результаты одновременно. Пригласи по ссылке за секунды.' },
    ...
    pricing: {
      ...
      sub: 'Никаких скрытых платежей. Отмена в один клик.',
      free: {
        name: 'Старт', price: '0 ₸', sub: 'Идеально для первого турнира',
        items: ['До 3 турниров', 'До 16 команд в каждом', 'Круговой и плей-офф форматы', 'Публичная ссылка для участников', 'Голы, ассисты и карточки', 'Логотипы команд и турниров', 'Экспорт в PDF и PNG'],
      ...
      pro: {
        ...
        items: ['Безлимитные турниры', 'До 64 команд в каждом', 'Live-табло в реальном времени', 'До 3 соредакторов', 'Все форматы: ЛЧ, ЧМ, кастомные', 'Приоритетная поддержка 24/7', 'Всё из бесплатного плана'],
        cta: 'Получить Про',
      },
      more: 'Нужно больше? ', moreLink: 'Напишите — найдём решение.',
    },
    services: {
      h2: 'Мы берём на себя всё',
      sub: 'Хотите полностью делегировать? Мы выедем к вам и возьмём на себя всё техническое.',
      items: [
        { icon: 'video', title: 'Профессиональная видеосъёмка', desc: 'Наша команда приедет на турнир и профессионально снимет каждый матч на поле. Видеозаписи появятся в вашем аккаунте автоматически.', price: null, pricePer: null, badge: 'Скоро', badgeColor: 'blue' },
        { icon: 'trophy', title: 'Оператор на ваш турнир', desc: 'Наш специалист приедет и будет вносить результаты всех матчей прямо в платформу. Вы проводите турнир — мы берём на себя всё техническое.', price: '19 990 ₸', pricePer: 'в день', badge: null, badgeColor: null },
      ],
    },
    contact: { h2: 'Есть вопрос? Пишите.', sub: 'Отвечаем в течение часа. Без роботов.', wa: 'Написать в WhatsApp', phone: '+7 (706) 409-20-21' },
    cta: { h2: 'Ваш следующий турнир — уже сегодня.', sub: 'Зарегистрируйтесь за 30 секунд. Создайте турнир. Удивите участников.', btn: 'Начать бесплатно' },
    footer: {
  ...
  kz: {
    ...
    live: {
      badge: 'Live-тақта',
      h2: ['Қатысушылар есепті', 'қосымшасыз көреді.'],
      sub: 'Матчқа дейін чатқа сілтемені жіберіңіз. Телефоннан голдарды енгізіңіз — барлығы есепті, карточкаларды және таймерді лезде көреді. Жүктеулерсіз. Тіркелусіз.',
      items: [
        'Жинақталған уақытпен, үзілісімен және қосымша уақытпен матч таймері',
        'Голдар мен ассисттер ойыншы мен минутамен байланысты',
        'Сары және қызыл карточкалар матч хронологиясында',
        'Жалпыға ортақ URL — бір шерту, бүкіл команда хабардар',
      ],
    },
    stats: {
      h2: ['Статистика — өздігінен.', 'Экспорт — бір шертумен.'],
      sub: 'Қолмен есептеу жоқ. Бомбардирлер, ассистенттер, тәртіп — әр нәтиже енгізілгеннен кейін автоматты есептеледі.',
      items: [
        'Өзекті деректермен бомбардирлер мен ассистенттер кестесі',
        'Әр команда бойынша сары, қызыл карточкалар мен ескертулерді есепке алу',
        'Доп айырмасы мен ұпайларды автоматты есептеу',
        'PDF-ке толық есепті экспорттау — басып шығаруға немесе әлеуметтік желілерге',
      ],
    },
    features: {
      tag: 'Мүмкіндіктер',
      ...
      items: [
        ...
        { title: 'Бірнеше редактор', desc: 'Көмекші алыңыз — 3 соредакторға дейін нәтижелерді бір уақытта енгізеді. Секундтарда сілтемемен шақырыңыз.' },
    ...
    pricing: {
      h2: 'Тегін — мәңгі.\nПро — дайын болғанда.',
      sub: 'Жасырын төлемдер жоқ. Бір шертумен болдырмау.',
      free: {
        name: 'Бастамашы', price: '0 ₸', sub: 'Бірінші турнир үшін тамаша',
        items: ['3 турнирге дейін', 'Әр турнирде 16 командаға дейін', 'Дөңгелек және плей-офф форматтары', 'Қатысушыларға жалпыға ортақ сілтеме', 'Голдар, ассисттер және карточкалар', 'Команда мен турнир логотиптері', 'PDF және PNG экспорты'],
      ...
      pro: {
        ...
        items: ['Шексіз турнирлер', 'Әр турнирде 64 командаға дейін', 'Нақты уақытта Live-тақта', '3 соредакторға дейін', 'Барлық форматтар: ЛЧ, ЧА, кастомды', 'Басым қолдау 24/7', 'Тегін жоспардың барлығы'],
        cta: 'Про алу',
      },
      more: 'Көбірек керек пе? ', moreLink: 'Жазыңыз — шешім табамыз.',
    },
    services: {
      h2: 'Барлығын біз аламыз',
      sub: 'Толықтай тапсырғыңыз келе ме? Біз сізге барып, барлық техникалық бөлігін өз мойнымызға аламыз.',
      items: [
        ...
        { icon: 'trophy', title: 'Турниріңізге оператор', desc: 'Маманымыз келіп, барлық матч нәтижелерін тікелей платформада тіркейді. Сіз турнирді өткізесіз — техникалық бөлігін біз аламыз.', price: '19 990 ₸', pricePer: 'күніне', badge: null, badgeColor: null },
      ],
    },
    contact: { h2: 'Сұрағыңыз бар ма? Жазыңыз.', sub: 'Бір сағат ішінде жауап береміз. Роботсыз.', wa: 'WhatsApp-қа жазу', phone: '+7 (706) 409-20-21' },
    cta: { h2: 'Келесі турниріңіз — бүгін.', sub: '30 секундта тіркеліңіз. Турнир жасаңыз. Қатысушыларды таң қалдырыңыз.', btn: 'Тегін бастау' },
    footer: {
  ...
  en: {
    ...
    live: {
      ...
      h2: ['Everyone sees the score.', 'No app required.'],
      sub: 'Drop the link in the group chat before the match. Enter goals from your phone — everyone sees the score, cards and timer instantly. No downloads. No sign-up.',
      items: [
        'Match timer with accumulated time, pause and extra time',
        'Goals and assists linked to specific players and minutes',
        'Yellow and red cards in the match timeline',
        'Public URL — one tap and the whole team is in the loop',
      ],
    },
    stats: {
      h2: ['Stats — automatic.', 'Export — one click.'],
      sub: 'No manual counting. Top scorers, assists, discipline — recalculated automatically after every result.',
      items: [
        'Live top scorers and assists table',
        'Yellow, red cards and warnings tracked per team',
        'Automatic goal difference and points calculation',
        'Export full report to PDF — for print or social media',
      ],
    },
    features: {
      tag: 'Features',
      ...
      items: [
        ...
        { title: 'Multiple editors', desc: 'Bring a helper — up to 3 co-editors enter results at the same time. Invite by link in seconds.' },
    ...
    pricing: {
      ...
      free: {
        name: 'Starter', price: '0 ₸', sub: 'Perfect for your first tournament',
        items: ['Up to 3 tournaments', 'Up to 16 teams each', 'Round-robin & playoff formats', 'Public link for participants', 'Goals, assists & cards', 'Team & tournament logos', 'PDF & PNG export'],
        cta: 'Create tournament for free',
      },
      pro: {
    ...
    services: {
      ...
      sub: 'Want to fully delegate? We come to you and take care of all the technical side.',
      items: [
        ...
        { icon: 'trophy', title: 'On-site results operator', desc: 'Our specialist arrives and enters all match results directly into the platform. You run the tournament — we handle the technical side.', price: '19,990 ₸', pricePer: 'per day', badge: null, badgeColor: null },
      ],
    },
    contact: { h2: 'Got a question? Write to us.', sub: 'We respond within an hour. Real people, no bots.', wa: 'Message on WhatsApp', phone: '+7 (706) 409-20-21' },
    cta: { h2: 'Your next tournament starts today.', sub: 'Sign up in 30 seconds. Create a tournament. Impress your participants.', btn: 'Start for free' },
    footer: {
      tagline: 'Professional tournaments for any team sport — from street to final.',
      ...
      <section id="contact" className="py-20 lg:py-28 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-center mt-8 text-sm text-gray-400">
            ...
            <a href="mailto:tournable.webapp@gmail.com" className="text-emerald-600 font-semibold hover:underline">tournable.webapp@gmail.com</a>
          </p>
        </div>
      </section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:tournable.webapp@gmail.com" className="w-9 h-9 rounded-xl bg-gray-800 hover:bg-gray-700 flex items-center justify-center transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="mailto:tournable.webapp@gmail.com" className="text-sm text-gray-500 hover:text-white transition-colors">tournable.webapp@gmail.com</a></li>
              </ul>
            </div>
          </div>

...
const T = {
  ru: {
    ...
    live: {
      ...
      sub: 'Запустите табло до матча — счёт, голы и карточки мгновенно появляются на экране у каждого зрителя. Проецируйте на телевизор или большой экран. Без приложений, без регистрации, без задержки.',
      items: [
    ...
    features: {
      ...
      items: [
        { title: 'Турнир за минуту, а не за вечер', desc: 'Формат, команды — готово: расписание, сетка и таблица создаются сами. Круговой, плей-офф, группы, лига, швейцарка и двойное выбывание.' },
        { title: 'Табло на любом экране', desc: 'Счёт, таймер и события матча — в реальном времени у каждого зрителя. Проецируйте на телевизор: выглядит как трансляция.' },
    ...
    pricing: {
      ...
      features: [
        ...
        { label: 'Табло в реальном времени', free: true, pro: true, enterprise: true },
  ...
  kz: {
    ...
    live: {
      ...
      sub: 'Таблоны матчқа дейін іске қосыңыз — есеп, голдар мен карточкалар барлық тамашалаушылардың экранында лезде пайда болады. Теледидарға немесе экранға проекциялаңыз. Қосымшасыз, тіркелусіз, кешіктірусіз.',
      items: [
    ...
    features: {
      ...
      items: [
        { title: 'Турнир — кешке емес, бір минутқа', desc: 'Формат, командалар — дайын: кесте, тор және таблица өздігінен жасалады. Дөңгелек, плей-офф, топтар, лига, швейцариялық жүйе және қос шығару.' },
        { title: 'Кез келген экрандағы тақта', desc: 'Есеп, таймер және матч оқиғалары — әр көрерменде нақты уақытта. Теледидарға шығарыңыз: трансляция сияқты көрінеді.' },
    ...
    pricing: {
      ...
      features: [
        ...
        { label: 'Нақты уақыттағы тақта', free: true, pro: true, enterprise: true },
  ...
  en: {
    ...
    live: {
      badge: 'Scoreboard',
      h2: ['Real-time scores —', 'on every screen.'],
      sub: 'Turn on the scoreboard before the match — scores, goals and cards appear instantly on every spectator\'s screen. Project onto a TV or big screen. No app, no sign-up, no delay.',
      items: [
      ...
      imgAlt: 'Tournable — online scoreboard',
    },
    stats: {
      ...
      items: [
        ...
        'Real-time performance leaders and head-to-head matrix',
      ],
    ...
    features: {
      ...
      items: [
        { title: 'A tournament in a minute, not an evening', desc: 'Format, teams — done: schedule, bracket and table build themselves. Round-robin, playoff, groups, league, Swiss and double elimination.' },
        { title: 'Scoreboard on any screen', desc: 'Score, timer and match events — in real time for every spectator. Project onto a TV: looks like a broadcast.' },
    ...
    pricing: {
      ...
      features: [
        ...
        { label: 'Real-time scoreboard', free: true, pro: true, enterprise: true },

  ...
  ru: [
    ...
    },
    {
      ...
      steps: [
        ...
        'Pro включает: Табло, приоритетную поддержку 24/7.',
    ...
    },
    {
      ...
      steps: [
        ...
        '3. Текущий матч всегда наверху списка.',
  ...
  kz: [
    ...
    },
    {
      ...
      steps: [
        ...
        '3. Тақта ашылады — голдарды, ассисттерді, карточкаларды енгізіңіз.',
  ...
  en: [
    ...
    },
    {
      ...
      steps: [
        ...
        'Pro includes: Scoreboard, priority support 24/7.',
